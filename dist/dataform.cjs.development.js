...
var iconFa = require('react-icons/fa');
var iconAi = require('react-icons/ai');
var iconBs = require('react-icons/bs');
var iconBi = require('react-icons/bi');
var iconCi = require('react-icons/ci');
var iconDi = require('react-icons/di');
var iconFi = require('react-icons/fi');
var iconFc = require('react-icons/fc');
var iconGi = require('react-icons/gi');
var iconGo = require('react-icons/go');
var iconGr = require('react-icons/gr');
var iconHi = require('react-icons/hi');
var iconHi2 = require('react-icons/hi2');
var iconIm = require('react-icons/im');
var iconIo = require('react-icons/io');
var iconIo5 = require('react-icons/io5');
var iconMd = require('react-icons/md');
var iconRx = require('react-icons/rx');
var iconRi = require('react-icons/ri');
var iconSi = require('react-icons/si');
var iconSl = require('react-icons/sl');
var iconTb = require('react-icons/tb');
var iconTfi = require('react-icons/tfi');
var iconTi = require('react-icons/ti');
var iconVsc = require('react-icons/vsc');
var iconWi = require('react-icons/wi');
var iconCg = require('react-icons/cg');
...
var ColorPicker = require('react-best-gradient-color-picker');
var ColorPicker__default = _interopDefault(ColorPicker);
var Select = _interopDefault(require('react-select'));
var solid = require('@heroicons/react/20/solid');
var data = _interopDefault(require('@emoji-mart/data'));
var Picker = _interopDefault(require('@emoji-mart/react'));
...
var ButtonWithConfirm = function ButtonWithConfirm(props) {
  ...
  reactUse.useClickAway(ref, function () {
    setConfirm(false);
  });
  var clickHandler = function clickHandler() {
    if (confirm) {
...
var SlidesLayout = function SlidesLayout(props) {
  ...
  return React__default.createElement("div", null, React__default.createElement(react$1.Swiper, {
    spaceBetween: 50,
    slidesPerView: 3,
    ...
    return React__default.createElement(react$1.SwiperSlide, {
      key: _index
    }, React__default.createElement("div", {
      key: _index,
      onClick: function onClick(e) {
...
function SwitchInput() {
  ...
  return React__default.createElement(react.Switch, {
    checked: enabled,
    onChange: setEnabled,
...
function RadioInput(props) {
  var _useState = React.useState(props.options[0]),
  ...
  }, React__default.createElement(react.RadioGroup, {
    value: selected,
    onChange: setSelected
  }, React__default.createElement(react.RadioGroup.Label, {
    className: "sr-only"
  }, "Server size"), React__default.createElement("div", {
    className: "space-y-2"
  }, props.options.map(function (item) {
    return React__default.createElement(react.RadioGroup.Option, {
      key: item.value,
      value: item.label,
      ...
      }, item.name), React__default.createElement(react.RadioGroup.Description, {
        as: "span",
...
var SliderRangeInput = function SliderRangeInput(_ref) {
  ...
  var _useState = React.useState(initialMinValue),
    minValue = _useState[0],
    setMinValue = _useState[1];
  var _useState2 = React.useState(initialMaxValue),
...
var useDataformStore = /*#__PURE__*/create(function (set, get) {
  return {
    data: {},
    refreshList: {},
    ...
    setData: function setData(keyPath, value) {
      return set(function (state) {
        var data = immer.produce(state.data, function (draft) {
    ...
    addArrayItem: function addArrayItem(keyPath, defaultItem) {
      return set(function (state) {
        var _extends2;
        var data = immer.produce(state.data, function (draft) {
          var current = objectPath.get(draft, keyPath);
          if (current) {
...
var CommonColorPicker = function CommonColorPicker(props) {
  ...
  var _useState2 = React.useState('rgba(255, 255, 255, 1)'),
    gradient = _useState2[0],
    setGradient = _useState2[1];
  var _useState3 = React.useState(false),
    show = _useState3[0],
    setShow = _useState3[1];
  var _useColorPicker = ColorPicker.useColorPicker(gradient, setGradient),
    valueToHex = _useColorPicker.valueToHex,
    rgbaArr = _useColorPicker.rgbaArr;
  var _useState4 = React.useState(props.color || '#000'),
  ...
  var getPicker = function getPicker() {
    ...
    switch (props.type) {
      case 'sketch':
        selPicker = React__default.createElement(reactColor.SketchPicker, {
        ...
        break;
      case 'chrome':
        selPicker = React__default.createElement(reactColor.ChromePicker, {
        ...
        break;
      case 'photoshop':
        selPicker = React__default.createElement(reactColor.PhotoshopPicker, {
      ...
      case 'gradient':
        ...
        }, React__default.createElement(ColorPicker__default, {
          value: gradient,
          onChange: handleGradientChange
        }));
        break;
      default:
        selPicker = React__default.createElement(reactColor.GithubPicker, {
...
var BasicElement = function BasicElement(_ref) {
  ...
  var _useState = React.useState(getData(keyPath)),
    value = _useState[0],
    setValue = _useState[1];
...
var emojiMartCustom = [{
  ...
  emojis: /*#__PURE__*/Object.keys(iconFa).map(function (key) {
    var Icon = iconFa[key];
    var svgString = server.renderToStaticMarkup(React__default.createElement(Icon, null));
...
function IconPicker() {
  ...
  return React__default.createElement("div", {
    ...
    var open = _ref.open;
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(react.Popover.Button, {
    ...
    }, value)), React__default.createElement(solid.ChevronDownIcon, {
...
function Notification() {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
  ...
  }, React__default.createElement(outline.CheckCircleIcon, {
    ...
    className: "sr-only"
  }, "Close"), React__default.createElement(solid.XMarkIcon, {
    className: "h-5 w-5",
    "aria-hidden": "true"
  }))))))))));
}
...
var CustomJsonSchemaForm = function CustomJsonSchemaForm(_ref) {
  ...
  return React.createElement("div", {
    ...
    type: "submit"
  }, "Submit")), React.createElement(Notification, null));
};

// Delete me
var Dataform = function Dataform(props) {
  return React.createElement(CustomJsonSchemaForm, Object.assign({}, props));
};

exports.Dataform = Dataform;
//# sourceMappingURL=dataform.cjs.development.js.map
